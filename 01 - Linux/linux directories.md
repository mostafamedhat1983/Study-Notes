...
- `/proc`: Virtual filesystem for process and kernel info (e.g., `/proc/cpuinfo`).[](https://www.tutorialspoint.com/unix/unix-directories.htm)​
    
- `/root`: Root user's home directory.[](https://www.tutorialspoint.com/unix/unix-directories.htm)​
    
- `/sbin`: System admin binaries like `fdisk`, `reboot`.
    
- `/tmp`: Temporary files, cleared on reboot.[](https://www.tutorialspoint.com/unix/unix-directories.htm)​
...
Run `ls -l /` as root (via `sudo`) to list root contents.[](https://www.geeksforgeeks.org/linux-unix/linux-directory-structure/)​
