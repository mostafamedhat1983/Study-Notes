...
- **Memory management** like allocating and freeing memory.[](https://iframe-ucl-de.heineken.com/download/primo-explore/nPjUpw/The_Linux_Programming_Interface.pdf)
    
- **String handling** like copying, comparing, or joining text.[](https://www.reddit.com/r/linuxquestions/comments/n5jywa/what_is_a_linux_library/)
    
- **Math operations** like square roots, powers, or trigonometric calculations.[](https://www.reddit.com/r/linuxquestions/comments/n5jywa/what_is_a_linux_library/)
